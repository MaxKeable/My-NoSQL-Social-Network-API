...
const userSchema = new Schema(
  ...
  {
    toJSON: {
      virtuals: true, // allows virtual properties to be displayed when a user document is transformed into JSON format
    },
    id: false, // disables the default '_id' field in the User model to be returned when calling toJSON() method
  }
);

// creating a virtual property 'friendCount' which returns the number of friends in the friends array
